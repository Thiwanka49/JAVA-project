		...
		<nav class="mainnav shadow navbar-expand-lg navbar navbar-dark bg-dark fixed-top" style="min-width: 350px">
		  <div class="container-fluid">
		    <a class="navbar-brand" href="#">
		    	...
		    	<div style="font-size: 15px">Unleash your potential</div>
		    </a>
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
		        <li class="nav-item"> 
		          <a class="nav-link active" aria-current="page" href="http://localhost:8076/Deezer/index.jsp">Home</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="https://www.chosic.com/">Discover</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="https://www.boomplay.com/trending-songs">Trending</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="https://www.boomplay.com/genres/34">Electronic</a>
		        </li>
